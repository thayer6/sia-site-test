"""
Django settings for sitetest project on Heroku. For more info, see:
...
SECRET_KEY = "(rwxqoh+xnobo*u7*_!oal60_+&c_fdj95%s+-c^2=%+6k+yu7"
...
#     "get_users_count": {
#         'task': 'supertest.users.tasks.get_users_count',
#         'schedule': crontab()
#     }
# }